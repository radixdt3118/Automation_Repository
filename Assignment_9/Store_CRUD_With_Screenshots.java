...
public class Store_CRUD_With_Screenshots extends Get_From_Properties{
	...
	public static void takeScreenshot(String name,WebDriver driver) throws IOException {
		...
		String screenshot_dir = "src/main/java/Waits_screenshot_iframe/Screenshots/";
...
//					writer.write("Exception :- "+field+"\n");
			...
			//Editing store = 9prints
			Thread.sleep(1000);
			String store_xpath = String.format(getXPath("actions_store", properties), "09Prints");
			driver.findElement(By.xpath(store_xpath)).click();
			driver.findElement(By.xpath(getXPath("edit_store", properties))).click();
			driver.findElement(By.xpath(getXPath("store_name", properties))).clear();
			driver.findElement(By.xpath(getXPath("store_name", properties))).sendKeys("00009Prints");
			takeScreenshot("Store_Edit.jpg", driver);
			driver.findElement(By.xpath(getXPath("save_and_back", properties))).click();
			Thread.sleep(2000);
			
			//Deleting store 10Prints
			store_xpath = String.format(getXPath("actions_store", properties), "10Prints");
			driver.findElement(By.xpath(store_xpath)).click();
			driver.findElement(By.xpath((getXPath("delete_store", properties)))).click();
			takeScreenshot("Store_Delete.jpg", driver);
			Thread.sleep(500);
			driver.findElement(By.xpath((getXPath("confirm_delete", properties)))).click();
			Thread.sleep(2000);
			
			//Viewing store = 11Prints
			store_xpath = String.format(getXPath("actions_store", properties), "11Prints");
			driver.findElement(By.xpath(store_xpath)).click();
			driver.findElement(By.xpath(getXPath("view_store", properties))).click();
			Thread.sleep(500);
			takeScreenshot("Store_View.jpg", driver);
